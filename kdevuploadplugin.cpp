...
K_EXPORT_PLUGIN(UploadFactory(KAboutData("kdevupload", "kdevupload", ki18n("Upload"), VERSION_STR, ki18n("Upload project files to a remote server"), KAboutData::License_GPL)
