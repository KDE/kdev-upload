...
K_EXPORT_PLUGIN(UploadFactory(KAboutData("kdevupload", "kdevupload", ki18n("Upload"), KDEVUPLOAD_VERSION_STR, ki18n("Upload project files to a remote server"), KAboutData::License_GPL)
